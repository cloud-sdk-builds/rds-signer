...
[`@aws-sdk/rds-signer`](https://www.npmjs.com/package/@aws-sdk/rds-signer/v/3.1056.0).
...
- @aws-sdk/rds-signer - [https://cloud-sdk-builds.github.io/?sdk=rds-signer](https://cloud-sdk-builds.github.io/?sdk=rds-signer)
- @aws-sdk/rds-signer v3.1056.0 - [https://cloud-sdk-builds.github.io/?sdk=rds-signer&version=3.1056.0](https://cloud-sdk-builds.github.io/?sdk=rds-signer&version=3.1056.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1056.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VBkz4d8UmHDJ7L8rDRrcQtCOA+DYXxu15heK5AeJlT1gf4jU/s3iYJB92WI/0Nz8
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/rds-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1056.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1056.0/index.min.mjs": "sha384-VBkz4d8UmHDJ7L8rDRrcQtCOA+DYXxu15heK5AeJlT1gf4jU/s3iYJB92WI/0Nz8"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/rds-signer";
...
```
https://github.com/cloud-sdk-builds/rds-signer/blob/refs/tags/3.1056.0/LICENSE
```
