...
[`@aws-sdk/rds-signer`](https://www.npmjs.com/package/@aws-sdk/rds-signer/v/3.1091.0).
...
- @aws-sdk/rds-signer v3.1091.0 - [https://cloud-sdk-builds.github.io/?sdk=rds-signer&version=3.1091.0](https://cloud-sdk-builds.github.io/?sdk=rds-signer&version=3.1091.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1091.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p0G7FSk4GW5KG1cyZ36qPbhcGPWrmok+0/BlgE/Q9t31lSX3nYRLER0tsHAPViW8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/rds-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1091.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1091.0/index.min.mjs": "sha384-p0G7FSk4GW5KG1cyZ36qPbhcGPWrmok+0/BlgE/Q9t31lSX3nYRLER0tsHAPViW8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/rds-signer/blob/refs/tags/3.1091.0/LICENSE
```
