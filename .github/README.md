...
[`@aws-sdk/rds-signer`](https://www.npmjs.com/package/@aws-sdk/rds-signer/v/3.1115.0).
...
- @aws-sdk/rds-signer v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=rds-signer&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=rds-signer&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1115.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/rds-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.1115.0/index.min.mjs": "sha384-s6jGINdMCJegocwVWL6VasAuJ/6uRYPltmnFV+D74ezYpQLqxFI9xNCdlLvkcOQj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/rds-signer/blob/refs/tags/3.1115.0/LICENSE
```
