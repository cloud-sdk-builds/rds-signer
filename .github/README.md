...
[`@aws-sdk/rds-signer`](https://www.npmjs.com/package/@aws-sdk/rds-signer/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.679.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/rds-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.679.0/index.min.mjs": "sha384-qfiuznXNylD5SafEXPqDe/OgRsPLjsWPlB9VRhQt08NfhPeeNu0Ot22lh9XZjrO1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/rds-signer/blob/refs/tags/3.679.0/LICENSE
```
