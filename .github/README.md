...
[`@aws-sdk/rds-signer`](https://www.npmjs.com/package/@aws-sdk/rds-signer/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-smrv8+FTUplR2OxTZquhPFNlOsWCVhdJ6gG9orSOYcjNTtxWuUVXoAuHhzKHWSjz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/rds-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.257.0/index.min.mjs": "sha384-smrv8+FTUplR2OxTZquhPFNlOsWCVhdJ6gG9orSOYcjNTtxWuUVXoAuHhzKHWSjz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/rds-signer/blob/refs/tags/3.257.0/LICENSE
```
