...
[`@aws-sdk/rds-signer`](https://www.npmjs.com/package/@aws-sdk/rds-signer/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.969.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/rds-signer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/rds-signer@3.969.0/index.min.mjs": "sha384-tyQZwLCDNlVm65hJd1AvjYbrIYbZD6rf7ditOW6GuGlGyPEgnfCdSXQUU1Yo2YVT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/rds-signer/blob/refs/tags/3.969.0/LICENSE
```
